...
class SegmentedControlViewController: UITableViewController {
    ...
    // MARK: Properties
    enum SegmentedControlView {
        static let tealiumEvent = "screen_view"
        static let screenName = "segmented control view"
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        TealiumHelper.trackView(SegmentedControlView.tealiumEvent,
                                dataSources: ["screen_name": SegmentedControlView.screenName as AnyObject])
    ...
    func configureTintedSegmentedControl() {
        ...
        tintedSegmentedControl.addTarget(self,
                                         action: #selector(SegmentedControlViewController.selectedSegmentDidChange(_:)),
                                         for: .valueChanged)
    }
    ...
    func configureCustomSegmentsSegmentedControl() {
        ...
        customSegmentsSegmentedControl
            .addTarget(self,
                       action: #selector(SegmentedControlViewController.selectedSegmentDidChange(_:)),
                       for: .valueChanged)
    }
