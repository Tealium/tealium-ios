...
class TextFieldViewController: UITableViewController, UITextFieldDelegate {
    ...
    // MARK: Properties
    enum TextFieldViewData {
        static let tealiumEvent = "screen_view"
        static let screenName = "text field view"
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        TealiumHelper.trackView(TextFieldViewData.tealiumEvent,
                                dataSources: ["screen_name": TextFieldViewData.screenName as AnyObject])
        configureTextField()
