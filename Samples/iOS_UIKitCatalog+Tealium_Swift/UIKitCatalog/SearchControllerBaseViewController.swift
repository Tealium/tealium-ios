/*
    ...
    Abstract:
    A table view controller that displays filtered strings
   (used by other view controllers for simple displaying and filtering of data).
*/
...
class SearchControllerBaseViewController: UITableViewController {
    ...
    // MARK: Properties
    let allResults = ["Here's", "to", "the", "crazy", "ones.", "The", "misfits.",
                      ...
                      "the", "human", "race", "forward.", "And", "while", "some", "may",
    ...
    var filterString: String? = nil {
        didSet {
            if filterString == nil || filterString!.isEmpty {
                ...
                SearchResultsViewData.searchResults = String(visibleResults.count)
            }
