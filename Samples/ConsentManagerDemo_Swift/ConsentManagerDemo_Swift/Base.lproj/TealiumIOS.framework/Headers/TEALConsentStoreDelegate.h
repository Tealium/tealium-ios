...
/**
 Delegate method that provides the consent status that the consent store will be updated to.
 
 @param consentStatus the consent status to be set.
 */
- (void)consentStoreConsentWillChangeWithState:(TEALConsentStatus)consentStatus;
