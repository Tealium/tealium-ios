...
extern NSString *const TEALDataSourceKey_ApplicationUUID;
...
extern NSString *const TEALDataSourceKey_DeviceNamesFileName;
...
extern NSString *const TEALDataSourceKey_Tealium_Event_Type;
...
extern NSString *const TEALDataSourceValue_DispatchType_Activity;
extern NSString *const TEALDataSourceValue_DispatchType_Conversion;
extern NSString *const TEALDataSourceValue_DispatchType_Derived;
